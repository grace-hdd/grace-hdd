...
- Strong foundation in C and system-level programming  
- Experience with concurrency, memory management, and IPC  
- Focus on correctness, edge cases, and clean logic  
